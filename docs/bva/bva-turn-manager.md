...
|--------|-----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|---------------------------------------|------------------------------------------------------------------------|
| Step 1 | userInputCard - the user's input from ui.promptPlayCard() | cardToPlay - the Card object to play (from getPlayableCard())                                                     | canPlayCard - whether the card is playable by the current player (from gameEngine.playerHasCard()) | Output from playing cat card combo - whether it was played or not (only obtained if getPlayableCard threw an exception) | Whether the player's turn has ended.  | None - continue or end the turn, depending on the validity of the card |
| Step 2 | String                                                    | Cases or Exception                                                                                                | Boolean                                                                                            | Boolean                                                                                                                 | Boolean                               | None - continue or end the turn, depending on the validity of the card |
| Step 3 | "", valid user input, invalid input                       | ATTACK, SKIP, TARGETED_ATTACK, SHUFFLE, SEE_THE_FUTURE, REVERSE, DRAW_FROM_BOTTOM, ALTER_THE_FUTURE, or exception | T/F                                                                                                | T/F                                                                                                                     | T/F                                   | Continue or end turn based on card playability and game state          |
...
|             | System under test                                                                                                                                                                                                                                                                             | Expected output                                                                  | Implemented? |
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|--------------|
| Test Case 1 | input1 = "". Inputs 2, 3, and 4 are never obtained. Make input 5 true so it doesn't prompt again.                                                                                                                                                                                             | Calls `endTurn()`                                                                | yes          |
| Test Case 2 | input1 = valid card ("attack"), input2 = ATTACK, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again.                                                                                                                                                       | Calls `doAttack()`                                                               | yes          |
| Test Case 3 | input1 = valid card ("see the future"), input2 = SEE_THE_FUTURE, input3 = true (can play). Input 4 = N/A. This would make it prompt again in reality, so make input 5 false and input 1 = "". This is test case 1.                                                                            | Calls `doSeeTheFuture()` and continues loop                                      | yes          |
| Test Case 4 | input1 = valid card ("alter the future"), input2 = ALTER_THE_FUTURE, input3 = false (cannot play it). Input 4 = N/A. This would make it reprompt. Make input 5 false and input 1 = "". This is test case 1.                                                                                   | Calls `ui.printPlayCardDoesNotHaveCardError()` and takes input 1 again           | yes          |
| Test Case 5 | input1 = invalid card ("invalid"), input2 = exception (invalid card), input 3 and 4 = N/A. It should call promptAndPlayComboCatCards, which would make it reprompt. Make input 5 false and input 1 = "".                                                                                      | Calls `promptAndPlayComboCatCards()` and takes input 1 again                     | yes          |
| Test Case 6 | (Impossible case.) input1 = valid card ("skip"), input2 = EXPLODE (impossible case), input 3 = true (also impossible) and 4 = N/A. It should throw an IllegalArgumentException.                                                                                                               | Throws IllegalArgumentException.                                                 | yes          |
| Test Case 7 | input1 = valid card ("alter the future"), input2 = ALTER_THE_FUTURE, input3 = true (can play). Input 4 = N/A. Make input 5 false so it prompts again. input1 = valid card ("skip"), input2 = SKIP, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again.     | Calls `doAlterTheFuture()` and continues loop. Calls `doSkip()` and ends loop    | yes          |
| Test Case 8 | input1 = valid card ("shuffle"), input2 = SHUFFLE, input3 = true (can play). Input 4 = N/A. Make input 5 false so it prompts again. input1 = valid card ("targeted attack"), input2 = TARGETED_ATTACK, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again. | Calls `doShuffle()` and continues loop. Calls `doTargetedAttack()` and ends loop | yes          |
| Test Case 9 | input1 = valid card ("reverse"), input2 = REVERSE, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again.                                                                                                                                                     | Calls `doReverse()` and ends loop                                                | yes          |
| Test Case 9 | input1 = valid card ("draw from bottom"), input2 = DRAW_FROM_BOTTOM, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again.                                                                                                                                   | Calls `doDrawFromBottom()` and ends loop                                         | yes          |