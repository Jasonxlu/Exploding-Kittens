...
### Step 1-3 Results
|        | Input                                                | Input 2                                             | Input 3                                                    | Input 4                                               | Output                                                                                                                                                                                                                                                 |
|--------|------------------------------------------------------|-----------------------------------------------------|------------------------------------------------------------|-------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Step 1 | Name of the player targeted from UI prompting        | String of the card the Targeted player is giving up | Cardpile/hand of the player being targeted                 | Cardpile/hand of the current player playing the combo | No effect if targeted player's hand is empty, otherwise -> Targeted player is prompted to give up a card and the card is removed from their hand, the current player adds the card to their hand, any invalid inputs results in re-prompting for input |
| Step 2 | Cases                                                | Cases                                               | Collection                                                 | Collection                                            | Current player is re-prompted for input/Targeted player is re-prompted for input or targeted player cardpile is updated and current player cardpile is updated or None                                                                                 |
| Step 3 | Empty string, Valid Player name, Invalid Player name | Invalid card string, valid card string              | [], [one element], [multiple elements], [max elements: 51] | [multiple elements], [max elements: 53]               | Current player is re-prompted for input/Targeted player is re-prompted for input or targeted player cardpile is updated and current player cardpile is updated or None                                                                                 |
...
|             | System under test                                                                                                                              | Expected output                                                                                                                                     | Implemented? |
|-------------|------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| Test Case 1 | Target name: ""; "John", Card name: "explode"; "attack", Target Hand: [ATTACK], CurrPlayer Hand: [SHUFFLE, SHUFFLE]                            | CurrPlayer is re-prompted for input, Target is re-prompted for input, Card is removed from target player's hand, Card is added to CurrPlayer's hand |              |
| Test Case 2 | Target name: "Invalid"; "Jane", Card name: "skip", Target Hand: [SKIP, SEE_THE_FUTURE], CurrPlayer Hand: [HAIRY_POTATO_CAT, FERAL_CAT, DEFUSE] | CurrPlayer is re-prompted for input, Card is removed from target's hand, Card is added to CurrPlayer's hand                                         |              |
| Test Case 3 | Target name: "John", Target Hand: [], CurrPlayer hand: [ALL 53 PLAYABLE CARDS]                                                                 | Target is not prompted for input, no effect to either cardpile                                                                                      |              |
| Test Case 4 | Target name: "Jane", Card name: "shuffle", Target Hand: [51 PLAYABLE CARDS, Shuffle included], CurrPlayer Hand: [RAINBOW_CAT, RAINBOW_CAT]     | Card is removed from target's hand, card is added to CurrPlayer's hand                                                                              |              |