...
| Test Case 9 | input1 = valid card ("reverse"), input2 = REVERSE, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again.                                                                                                                                                     | Calls `doReverse()` and ends loop                                                | no           |
