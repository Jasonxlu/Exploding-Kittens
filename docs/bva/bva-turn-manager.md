...
|             | System under test                                                                                                     | Expected output                                       | Implemented? |
|-------------|-----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|--------------|
| Test Case 1 | input1: "Joe", input2: ["Joe", "Bob"], input3: false, input4: false, input5: [] (impossible)                          | ui.printGameState called with print imploding = false | no           |
...
| Test Case 3 | input1: "", input2: [] (impossible), input3: true, input4: true, input5: [ATTACK]                                     | ui.printGameState called with print imploding = false | no           |
