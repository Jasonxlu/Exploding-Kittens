...
| Test Case 9 | input1 = valid card ("draw from bottom"), input2 = DRAW_FROM_BOTTOM, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again.                                                                                                                                   | Calls `doDrawFromBottom()` and ends loop                                         | no           |