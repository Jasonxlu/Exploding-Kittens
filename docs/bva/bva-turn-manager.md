...
|             | System under test                                                                             | Expected output                                                                                                                                                   | Implemented? |
|-------------|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| Test Case 1 | Target name: ""; "John", Card name: "explode"; "attack", Target Hand: [ATTACK]                | CurrPlayer is re-prompted for name input, CurrPlayer is re-prompted for card input, Card is removed from target player's hand, Card is added to CurrPlayer's hand |              |
| Test Case 2 | Target name: "Invalid"; "Jane", Card name: "skip", Target Hand: [SKIP, SEE_THE_FUTURE]        | CurrPlayer is re-prompted for input, Card is removed from target's hand, Card is added to CurrPlayer's hand                                                       |              |
| Test Case 3 | Target name: "John", Target Hand: []                                                          | Target is not prompted for input, no effect to either cardpile                                                                                                    |              |
| Test Case 4 | Target name: "Jane", Card name: "shuffle", Target Hand: [51 PLAYABLE CARDS, Shuffle included] | Card is removed from target's hand, card is added to CurrPlayer's hand                                                                                            |              |
| Test Case 5 | Target name: "Smith", Card name: "exploding kitten"; "defuse", Target Hand: [DEFUSE]          | CurrPlayer is re-prompted for card input, Card is removed from target player's hand and added to CurrPlayer's hand                                                |              |
