...
| Test Case 2  | input1 = valid card ("attack"), input2 = ATTACK, input3 = true (can play). Input 4 = N/A. Input 6 = false. Make input 5 true so it doesn't prompt again.                                                                                                                                                                        | Calls `doAttack()`, ATTACK card is removed from player hand.                                                                                                  | no           |
| Test Case 3  | input1 = valid card ("see the future"), input2 = SEE_THE_FUTURE, input3 = true (can play). Input 4 = N/A. Input 6 = false. This would make it prompt again in reality, so make input 5 false and input 1 = "". This is test case 1.                                                                                             | Calls `doSeeTheFuture()` and continues loop. SEE_THE_FUTURE removed from player hand.                                                                         | no           |
