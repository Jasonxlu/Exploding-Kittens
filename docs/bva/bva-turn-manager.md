...
| Test Case 5  | input1 = invalid card ("invalid"), input2 = exception (invalid card), input 3 and 4 = N/A. It should call promptAndPlayComboCatCards, which would make it reprompt. Input 6 = N/A. Make input 5 false and input 1 = "".                                                                                                         | Calls `promptAndPlayComboCatCards()` and takes input 1 again                     | yes          |
...
| Test Case 10 | input1 = valid card ("draw from bottom"), input2 = DRAW_FROM_BOTTOM, input3 = true (can play). Input 4 = N/A. Input 6 = true. Should reprompt. Use the same inputs, and make input 5 true so it doesn't prompt again.                                                                                                           | Continue loop, then calls `doDrawFromBottom()` and ends loop                     | no           |