...
## Method 15: ```public void playTurnLoop()```
...
|             | System under test                                                                                                                                                                                                  | Expected output                                                        | Implemented? |
|-------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|--------------|
| Test Case 1 | input1 = "". Inputs 2, 3, and 4 are never obtained. Make input 5 true so it doesn't prompt again.                                                                                                                  | Calls `advanceTurn()`                                                  | no           |
| Test Case 2 | input1 = valid card ("attack"), input2 = ATTACK, input3 = true (can play). Input 4 = N/A. Make input 5 true so it doesn't prompt again.                                                                            | Calls `doAttack()`                                                     | no           |
| Test Case 3 | input1 = valid card ("see the future"), input2 = SEE_THE_FUTURE, input3 = true (can play). Input 4 = N/A. This would make it prompt again in reality, so make input 5 false and input 1 = "". This is test case 1. | Calls `doSeeTheFuture()` and continues loop                            | no           |
| Test Case 4 | input1 = valid card ("alter the future"), input2 = ALTER_THE_FUTURE, input3 = false (cannot play it). Input 4 = N/A. This would make it reprompt. Make input 5 false and input 1 = "". This is test case 1.        | Calls `ui.printPlayCardDoesNotHaveCardError()` and takes input 1 again | no           |
| Test Case 5 | input1 = invalid card ("invalid"), input2 = exception (invalid card), input 3 and 4 = N/A. It should call promptAndPlayComboCatCards, which would make it reprompt. Make input 5 false and input 1 = "".           | Calls `promptAndPlayComboCatCards()` and takes input 1 again           | no           |
| Test Case 6 | (Impossible case.) input1 = valid card ("skip"), input2 = EXPLODE (impossible case), input 3 = true (also impossible) and 4 = N/A. It should throw an IllegalArgumentException.                                    | Throws IllegalArgumentException.                                       | no           |